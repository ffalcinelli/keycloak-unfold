    ...
    <#elseif section = "form">
        ...
        <form id="register" class="flex flex-col gap-3 mt-6" action="${url.loginAction}" method="post">
        ...
        <#if !isSetRetry?has_content && isAppInitiatedAction?has_content>
            <form action="${url.loginAction}" class="flex flex-col gap-3 mt-4" id="kc-webauthn-settings-form"
                  method="post">
                <button type="submit"
